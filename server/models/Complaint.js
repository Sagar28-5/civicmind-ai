...
const complaintSchema = new mongoose.Schema({
  ...
  authenticityReason: { type: String, default: 'Authentic issue detected' },
  resolutionVerificationScore: { type: Number, default: 0 },
  resolutionVerificationNotes: { type: String, default: '' },
